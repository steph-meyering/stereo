...
# file3 = open("/Users/steph/Documents/stereo-seeds/Blomst-ChillRain.mp3")
# song3.file.attach(io: file3, filename: "file3")

# photo3 = open("/Users/steph/Documents/stereo-seeds/blomst-chillrain.jpg")
...
# file4 = open("/Users/steph/Documents/stereo-seeds/FosterThePeople-PumpedUpKicks.mp3")
# song4.file.attach(io: file4, filename: "file4")

# photo4 = open("/Users/steph/Documents/stereo-seeds/FosterThePeople-PumpedUpKicks.jpg")
...
# file5 = open("/Users/steph/Documents/stereo-seeds/Gramatik-EastCoast.mp3")
# song5.file.attach(io: file5, filename: "file5")

# photo5 = open("/Users/steph/Documents/stereo-seeds/Gramatik-EastCoast.jpg")
...
# file6 = open("/Users/steph/Documents/stereo-seeds/KillTheNoise-Salvation.mp3")
# song6.file.attach(io: file6, filename: "file6")

# photo6 = open("/Users/steph/Documents/stereo-seeds/KillTheNoise-Salvation.jpg")
...
# file7 = open("/Users/steph/Documents/stereo-seeds/kupla-feathers.mp3")
# song7.file.attach(io: file7, filename: "file7")

# photo7 = open("/Users/steph/Documents/stereo-seeds/kupla-feathers.jpg")
...
# file8 = open("/Users/steph/Documents/stereo-seeds/Letherette-CartoonHaunt.mp3")
# song8.file.attach(io: file8, filename: "file8")

# photo8 = open("/Users/steph/Documents/stereo-seeds/Letherette-CartoonHaunt.jpg")
...
# file9 = open("/Users/steph/Documents/stereo-seeds/saib-pianobar.mp3")
# song9.file.attach(io: file9, filename: "file9")

# photo9 = open("/Users/steph/Documents/stereo-seeds/saib-pianobar.jpg")
...
# file10 = open("/Users/steph/Documents/stereo-seeds/tails-Misted.mp3")
# song10.file.attach(io: file10, filename: "file10")

# photo10 = open("/Users/steph/Documents/stereo-seeds/tails-Misted.jpg")
...
# file11 = open("/Users/steph/Documents/stereo-seeds/WaxTailor-QueSera.mp3")
# song11.file.attach(io: file11, filename: "file11")

# photo11 = open("/Users/steph/Documents/stereo-seeds/WaxTailor-QueSera.jpg")
# song11.photo.attach(io: photo11, filename: "photo11")

# # ======TEMPLATE==========================Wax Tailor - Que Sera
# # ================================
# # song@ = Song.create(
# #     artist_id: guest.id, 
# #     title:"", 
